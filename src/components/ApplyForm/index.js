...
export function ApplyForm() {
    ...
    return (
        ...
        <form name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" action="https://elastic-goodall-7b6b88.netlify.app/thank-you/" style={{ border: "1px solid black" }} >
